  ...
  "mainEntity": [
{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Το Technical SEO Audit είναι μια μέθοδος για να ελέγξουμε την τεχνική υποδομή του site. Το πιο απλό Technical SEO Audit περιλαμβάνει: indexability [πόσες σελίδες είναι στην Google], OnPage SEO, Content analysis [πχ thin content], αρχιτεκτονική του site [πχ Ancor Text, Vertical Link Structire], internal linking, status codes [πχ error 500], Speed Audit [πχ GTmetrix]."}
},
